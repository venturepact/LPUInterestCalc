...
<div class="col-md-12 col-xs-12 np mt40 mb40">
	...
	<div class="col-md-4 col-xs-8 text-center">
		<span class="pagination-circle"><span id="step-1" class="not-hover pc-inside"></span></span>
		<span class="pagination-circle pagable"><span id="step-6" class="step-1 pc-inside"></span></span>
		<span class="pagination-circle pagable"><span id="step-2" class="step-2 pc-inside-light"></span></span>
		<span class="pagination-circle pagable"><span id="step-3" class="step-3 pc-inside-light"></span></span>
		<span class="pagination-circle pagable"><span id="step-4" class="step-4 pc-inside-light"></span></span>
		<span class="pagination-circle pagable"><span id="step-5" class="step-5 pc-inside-light"></span></span>
	</div>
	<div class="col-md-4 col-xs-2 cp-border-t cp-border-b np mt10"></div>
</div>
<?php 
		...
		//Hidden Field for the Answer of the Question from LinkedIn
		echo $form->hiddenField($project,'name');
?>
...
<div class="col-md-12 mt25 slide-div4" id="slide-3">
	<div class="col-md-12 col-xs-12 np">
...
<div class="col-md-12 col-xs-12 mt25 slide-div5" id="slide-4">
	<div class="col-md-12 col-xs-12 text-center np">
		<div class="mt10">
...
<div class="col-md-12 col-xs-12 slide-div6" id="slide-5">
	<div class="col-md-12 col-xs-12 text-center np">
		...
		<div class="modal-body col-md-12 np new-modal-bg">
			 <div class="col-md-12 mt30 mb10 admin-form theme-primary">
				...
				<div class="col-md-12 form-group mb5">
					<h4 class="mt0 font_newregular">Select a few times below that work for you:</h4>
...
$(document).ready(function(){
	...
	$('#ClientProjects_name').val(requirement);
	//localStorage.removeItem('requirement');
	
	$('.pagable').click(function() {
		var elem = $(this).children('span');
		if(elem.hasClass('pc-inside') && elem.parent().next().children('.pc-inside').length != 0) {
			var step = elem.attr('class').split(' ')[0].split('-')[1];
			var currentId = $('.currentSlide').attr('id').split('-')[1];
			//alert(step + ":step - - current: " + currentId);
	...
	$('.next-btn').click(function(e){
		var that = $(this);
		var validate;
		if($('.slide-div5').hasClass('currentSlide'))
		{
		...
		if(validate == true)
		{
			...
			$.ajax({
				url:"<?php echo Yii::app()->createUrl('site/createProject'); ?>",
				method:'POST',
				data:form,
				success:function(data){
