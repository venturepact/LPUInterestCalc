			...
			<div class="search-suppliers_home">
				<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<div class="col-md-10 col-md-offset-1 text-center mt30">
						<div class="admin-form form-horizontal rs-placeholder">
			...
			<div class="col-md-12 col-sm-12 col-xs-12 text-center pa20 rs-np">
				...
				<div class="col-md-12 col-xs-12 mt40">
					<div class="col-md-12 np  mb40">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="item col-md-3 rs-mb10"><img src="<?php echo Yii::app()->theme->baseUrl;?>/images/homepage/c-espn.png" class="gray-img" alt="ESPN" width="200"/ ></div>
							<div class="item col-md-3 rs-mb10"><img src="<?php echo Yii::app()->theme->baseUrl;?>/images/homepage/c-fb.png" class="gray-img" alt="FinansBank" width="230"/>						</div>
							...
							<div class="item col-md-3 rs-mb10 pt10"><img src="<?php echo Yii::app()->theme->baseUrl;?>/images/homepage/c-ah-gr.png" class="gray-img" alt="Athena Health" width="210"/></div>
						</div>
						<div class="col-md-12 col-sm-12 col-xs-12">
							...
							<div class="item col-md-3 rs-mb10"><img src="<?php echo Yii::app()->theme->baseUrl;?>/images/homepage/c-ashoka.png" class="gray-img" alt="Ashoka" width="230"/></div>
							...
							<div class="item col-md-3 rs-mb10"><img src="<?php echo Yii::app()->theme->baseUrl;?>/images/homepage/c-adidas.png" class="gray-img" alt="Adidas" width="200"/></div>
						</div>
					</div>
				</div>
			</div>
			...
			<div itemscope itemtype="http://schema.org/LocalBusiness" class="col-md-12 col-sm-12 col-xs-12 pa20 mt40 rs-np rs-nm">
				<div class="bb2 pb10 col-md-12 col-xs-12 np pb40">
					<div class="col-md-6 col-sm-6 col-xs-8 col-xs-offset-2 rs-show">
						<img src="<?php echo Yii::app()->theme->baseUrl;?>/images/homepage/waste-money.png" alt="dont waste money" class="pull-right mt15 rs-img" />
					</div>
				...
				<div class="col-md-10 col-md-offset-1 col-sm-12 col-xs-12 mt40 rs-np rs-bb2">
					<div class="col-md-2 col-sm-3 col-xs-12 rs-center rs-mb10 rs-np">
						<img src="<?php echo Yii::app()->theme->baseUrl;?>/images/homepage/eyepi.png" alt="Ceo" class="img-circle rs-img gray-img" />
					</div>
			...
			<div class="col-md-12 col-sm-12 col-xs-12 pa20 mt40 rs-np rs-nm">
				<div class="bb2 pb10 col-md-12 col-xs-12 np pb40">
					<div class="col-md-6 col-sm-4 col-xs-8 col-xs-offset-2 rs-show rs-mt25">
						<img src="<?php echo Yii::app()->theme->baseUrl;?>/images/homepage/dont-rely.png" alt="dont rely" class="pull-right mt15 rs-img  gray-img" />
					</div>
				...
				<div class="col-md-10 col-md-offset-1 col-sm-12 col-xs-12 mt40 rs-np rs-bb2">
					<div class="col-md-2 col-sm-3 col-xs-12 rs-center rs-mb10 rs-np">
						<img src="<?php echo Yii::app()->theme->baseUrl;?>/images/homepage/kram.png" alt="Ceo" class="img-circle rs-img gray-img" />
					</div>
					<div itemprop="review" itemscope itemtype="http://schema.org/Review" class="col-md-10 col-sm-9 col-xs-12 rs-mb10 rs-np">
						<span class="fs16 lh-22 h-text5">
			...
			<div itemscope itemtype="http://schema.org/LocalBusiness" class="col-md-12 col-sm-12 col-xs-12 pa20 mt40 rs-np">
				<div class="bb2 pb10 col-md-12 col-xs-12 np pb40">
					<div class="col-md-6 col-sm-4 col-xs-8 col-xs-offset-2 rs-show">
						<img src="<?php echo Yii::app()->theme->baseUrl;?>/images/homepage/escrow.png" alt="Escrow Payment" class="pull-right mt15 rs-img" />
					</div>
				...
				<div class="col-md-10 col-md-offset-1 col-sm-12 col-xs-12 mt40 rs-np">
					<div class="col-md-2 col-sm-3 col-xs-12 rs-center rs-mb10 rs-np">
						<img src="<?php echo Yii::app()->theme->baseUrl;?>/images/homepage/klink-logo.jpg" alt="Ceo" class="img-circle rs-img gray-img" />
					</div>
					<div itemprop="review" itemscope itemtype="http://schema.org/Review" class="col-md-10 col-sm-9 col-xs-12 rs-mb10 rs-np">
						<span class="fs16 lh-22 h-text5">
	...
	<div class="error-table-layout trusted-div remove-css">
		<div class="container mt80">
			<div class="col-md-12 col-sm-12 col-xs-12 text-center ">
				<img class="" alt="Gift" src="<?php echo Yii::app()->theme->baseUrl;?>/images/homepage/gift.png">
			</div>
...
<!--<section class="col-md-12 col-sm-12 col-xs-12 np slide bp-gradient-bg table-div">
	<div  class="error-table-layout trusted-div remove-css">
		<div class="container mt80">
			<div class="row light_bg np profile-top text-center min-h370 rs-pb30 rs-mt25">
				<h1 class="blue-head mt40 ">Earn Over <span class="text_white fs30">$500</span> For Everyone You Invite.</h1>
				<h3 class="blue-head mb40">(80% of our members save at least $1500 on their projects)</h3>
					...
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="text_white fs16 font_newregular col-md-11 text-center line-height24 light-blue-b pb20">1. Share with friends & businesses that are looking for tech talent. </div>
							<div class="col-md-10 col-sm-12 col-xs-12 mt20">
								<img src="<?php //echo Yii::app()->theme->baseUrl;?>/images/ref1.jpg" alt="banner" />
							</div>
					</div>
					<div class="col-md-4 col-sm-12 col-xs-12">
						...
						<div class="col-md-10 col-sm-12 col-xs-12 mt30">
							<img src="<?php //echo Yii::app()->theme->baseUrl;?>/images/ref2.jpg" alt="banner" />
						</div>
					</div>
					<div class="col-md-4 col-sm-12 col-xs-12">
						...
						<div class="col-md-10 col-sm-12 col-xs-12 mt20">
							<img src="<?php //echo Yii::app()->theme->baseUrl;?>/images/ref3.jpg" alt="banner" />
						</div>
					</div>
				</div>	
				<div class="col-md-12 text-center np mt20">
					<button type="button" value="Search" name='search' class="btn btn-orange fs14 pl15 pr15 pt10 pb10  lh-22 font_newregular" id="affiliateSignup">Generate Referral Code</button>
				</div>
			</div>
		</div>
	</div>
						...
						<div class="form-horizontal admin-form theme-primary col-md-8 col-md-offset-2 col-xs-12 modal-create-acc modal-create-acc-show">
							...
							<div class="form-group">
								...
								<div class="col-md-12 col-xs-12">
									...
									echo $form->textField($users,'first_name',array('placeholder'=>"Name",'required'=>'required','title'=>"Name",'data-parsley-pattern'=>"^[a-zA-Z ]+$",'data-parsley-minlength'=>"2",'class'=>'gui-input bb0 required alphanum minlength','length'=>"2",'tabindex'=>'1'));
									...
									if(Yii::app()->user->hasState('promo')){
										...
										if(Yii::app()->user->hasState('remail')){
											echo $form->emailField($users,'username',array('placeholder'=>"Email",'required'=>'required','data-parsley-type'=>"email",'title'=>"Email",'class'=>'gui-input bb0 required email','tabindex'=>'2','readonly'=>'readonly'));
										}else
											echo $form->emailField($users,'username',array('placeholder'=>"Email",'required'=>'required','data-parsley-type'=>"email",'title'=>"Email",'class'=>'gui-input bb0 required email','tabindex'=>'2'));
									}else{
										echo $form->emailField($users,'username',array('placeholder'=>"Your Email Address",'required'=>'required','data-parsley-type'=>"email",'title'=>"Email",'class'=>'gui-input bb0 required email','tabindex'=>'2'));
									}
									$users->password	=	'';
									echo $form->passwordField($users,'password',array('placeholder'=>"Password",'required'=>'required','title'=>"Password",'data-parsley-minlength'=>"6",'class'=>'gui-input bb2 required minlength','length'=>"6",'tabindex'=>'3'));?>
...
<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/957807862/?label=5bsQCJuAsV4Q9vnbyAM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>