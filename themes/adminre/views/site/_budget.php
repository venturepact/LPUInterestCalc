			...
			for($i=1;$i<4;$i++){
				...
				<tr>
					...
					<?php	if($preference=='city'){?>
									<a href="javascript:void();" class="label text-muted text-color"><?php echo $city;?></a>
					<?php	}elseif($preference=='country'){?>
									<a href="javascript:void();" class="label text-muted text-color"><?php echo $countryName;?></a>
					<?php	}else{
								$region	=	array();
...
<div id="no-more-tables" class="table-responsive iphone_table hide">
