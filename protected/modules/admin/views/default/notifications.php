...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 np layout-left">
    ...
    <div class="notification col-md-10 col-sm-10 col-xs-10">
                                ...
                                <li class="font_newregular">
                                    <div class="pl20">
                                        ...
                                        if($current['is_prior_admin'] && $_REQUEST['view'] == "admin" && $current['is_checked'] == 0) { 
                                            ?>
                                                <span class="checked pl30">Mark this seen: <input class="notification-seen" data-id="<?php echo $key; ?>" type="checkbox"></span>
                                            <?php 
                                        }
        ...
        <?php if( $seeMore == 1 ){ ?>
            ...
            <input type="hidden" value="<?php echo $_REQUEST['view'];?>" id="view"/>
